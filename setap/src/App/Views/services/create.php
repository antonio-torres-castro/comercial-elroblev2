...
<div class="container-fluid mt-4">
    <main class="col-12 px-md-4">
        ...
        <?php if (!empty($data['errors'])): ?>
            <div class="alert alert-danger"><ul class="mb-0"><?php foreach ($data['errors'] as $error): ?><li><?= htmlspecialchars($error); ?></li><?php endforeach; ?></ul></div>
        <?php endif; ?>
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <form id="serviceForm" method="POST" action="<?= AppConstants::ROUTE_SERVICES ?>/store">
                    ...
                    <div class="card mb-4">
                        <div class="card-header"><h5 class="mb-0"><i class="bi bi-info-circle"></i> Definicion comercial</h5></div>
                        <div class="card-body">
                            <div class="row g-3">
                                <?php if ($isAdmin): ?>
                                    <div class="col-md-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header"><h5 class="mb-0"><i class="bi bi-layers"></i> Version inicial</h5></div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive mt-3">
                                <table class="table table-hover align-middle">
                                    <thead class="table-dark"><tr><th>Orden</th><th>Proceso</th><th>Dia inicio</th><th>Obligatorio</th><th></th></tr></thead>
            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    <div class="card-header"><h5 class="mb-0"><i class="bi bi-tags"></i> Crear categoria</h5></div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header"><h5 class="mb-0"><i class="bi bi-ui-checks-grid"></i> Crear tipo</h5></div>
                    <div class="card-body">
