...
<body class="bg-light">
    ...
    <div class="container mt-4">
        <main class="main-content">
            ...
            <form method="POST" action="<?= AppConstants::ROUTE_PROJECTS_UPDATE ?>" id="editProjectForm">
                            ...
                            <div class="row">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="direccion" name="direccion" rows="1"
                                        placeholder="Dirección donde se desarrolla el proyecto..." required><?= htmlspecialchars($project['direccion'] ?? '') ?></textarea>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <select class="form-select" id="tarea_tipo_id" name="tarea_tipo_id" required>
                                            ...
                                            <?php foreach ($taskTypes as $taskType): ?>
                                                <option value="<?= (int)$taskType['id'] ?>"
                                                    <?= $taskType['id'] == $project['tarea_tipo_id'] ? 'selected' : '' ?>>
                            ...
                            <div class="row mb-0">
                                ...
                                <select class="form-select" id="contraparte_id" name="contraparte_id" required>
                                    ...
                                    <?php foreach ($counterparts as $counterpart): ?>
                                        <option value="<?= (int)$counterpart['id'] ?>" <?= $counterpart['id'] == $project['contraparte_id'] ? 'selected' : '' ?> data-cliente-id="<?= (int)$counterpart['cliente_id'] ?>">
