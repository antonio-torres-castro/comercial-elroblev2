                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="alert alert-warning">
                                    ...
                                    El formulario de gestión de tareas está en desarrollo.
                                    <?php if ($data['task_id']): ?>
                                        <br>ID de la tarea a editar: <strong><?php echo $data['task_id']; ?></strong>
                                    <?php else: ?>
                                        <br>Aquí podrás crear una nueva tarea.
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
