                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="alert alert-info">
                                    ...
                                    La gestión de tareas está en desarrollo. Próximamente podrás:
                                    <ul class="mb-0 mt-2">
                                        <li>Ver todas las tareas del sistema</li>
                                        <li>Crear nuevas tareas</li>
                                        <li>Asignar tareas a usuarios</li>
                                        <li>Hacer seguimiento de progreso</li>
                                        <li>Gestionar fechas de vencimiento</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
