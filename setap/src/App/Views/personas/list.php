            ...
            <nav class="col-md-2 d-md-block bg-light sidebar">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="/personas">
            ...
            <main class="col-md-10 ms-sm-auto px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <a href="/persona" class="btn btn-sm btn-primary">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="alert alert-info">
                                    ...
                                    La gestión de personas está en desarrollo. Próximamente podrás gestionar la información personal de usuarios, clientes y contactos.
                                </div>
                            </div>
                        </div>
                    </div>
