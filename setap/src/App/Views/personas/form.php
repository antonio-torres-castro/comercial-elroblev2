                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="alert alert-warning">
                                    ...
                                    El formulario de gestión de personas está en desarrollo.
                                    <?php if ($data['persona_id']): ?>
                                        <br>ID de la persona a editar: <strong><?php echo $data['persona_id']; ?></strong>
                                    <?php else: ?>
                                        <br>Aquí podrás crear una nueva persona.
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
