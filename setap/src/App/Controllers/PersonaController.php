...
class PersonaController
{
    ...
    public function index()
    {
        try {
            ...
            $data = [
                ...
                'subtitle' => 'Lista de todas las personas del sistema'
            ];

            require_once __DIR__ . '/../Views/personas/list.php';
    ...
    /**
     * Mostrar/editar persona individual (singular)
     */
    public function show($id = null)
    {
        try {
            ...
            $data = [
                ...
                'subtitle' => $id ? "Editando persona #$id" : 'Nueva persona',
                'persona_id' => $id
            ];

            require_once __DIR__ . '/../Views/personas/form.php';
