...
:root {
  ...
  --store-accent: #D2691E; /* Naranja café */
  --coffee-beige: #F5E6D3;
  --coffee-cream: #FFF8F0;
}
...
.store-hero {
  background: linear-gradient(135deg, var(--coffee-beige), var(--coffee-cream), var(--store-primary)05);
...
.store-hero::before {
  ...
  right: 0;
  bottom: 0;
  background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><pattern id="coffee-grain" width="20" height="20" patternUnits="userSpaceOnUse"><circle cx="10" cy="10" r="2" fill="%23' . str_replace('#', '', $primaryColor) . '" opacity="0.15"/></pattern></defs><rect width="100" height="100" fill="url(%23coffee-grain)"/></svg>');
  opacity: 0.4;
}
